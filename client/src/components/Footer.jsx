...
function FooterCom() {
    return ( <
        ...
        Footer.Link href = '#'
        target = '_blank'
        rel = 'noopener noreferrer' > Footer content 1 < /Footer.Link> <
        /Footer.LinkGroup> <
        Footer.LinkGroup col >
        <
        Footer.Link href = '/about'
        target = '_blank'
        rel = 'noopener noreferrer' > InkWeb 's Blog</Footer.Link> <
        /Footer.LinkGroup> <
        /div> <
        div >
        <
        ...
        Footer.LinkGroup col >
        <
        Footer.Link href = 'https://github.com/code-encounterer'
        target = '_blank'
        ...
        Footer.Link href = '#'
        target = '_blank'
        rel = 'noopener noreferrer' > Terms & amp; Conditions < /Footer.Link> <
        /Footer.LinkGroup> <
        /div> <
        /div> <
        /div> <
