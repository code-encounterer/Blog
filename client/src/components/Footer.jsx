  ...
  return (
    <Footer container className="border border-t-8 border-teal-500">
        <div className="w-full max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
                    <div>
                        ...
                        <Footer.LinkGroup col>
                            <Footer.Link href='#' target='_blank' rel='noopener noreferrer'>Footer content 1</Footer.Link>
                        </Footer.LinkGroup>
                        <Footer.LinkGroup col>
                            <Footer.Link href='/about' target='_blank' rel='noopener noreferrer'>InkWeb's Blog</Footer.Link>
                        </Footer.LinkGroup>
                    </div>
                    <div>
                        <Footer.Title title='Follow us' />
                        <Footer.LinkGroup col>
                            <Footer.Link href='https://github.com/code-encounterer' target='_blank' rel='noopener noreferrer'>GitHub</Footer.Link>
                        </Footer.LinkGroup>
                        <Footer.LinkGroup col>
            ...
            <Footer.Divider />
            <div className="">
                <Footer.Copyright href='#' by="InkWeb Blog" year={new Date().getFullYear()} />
            </div>
        </div>
    </Footer>
  )
